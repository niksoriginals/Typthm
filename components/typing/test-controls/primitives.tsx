...
export const groupClass =
  "flex items-center rounded-xl border border-foreground/[0.04] bg-foreground/[0.02] p-1 shadow-[0_1px_8px_rgba(0,0,0,0.02)] backdrop-blur-lg";
...
export function Selector({
  ...
  return (
    ...
    >
      ...
      {active && (
        <motion.span
          className="absolute inset-0 rounded-lg bg-primary/15 shadow-sm dark:bg-primary/10"
          layoutId={layoutId}
          transition={pillEase}
        />
      )}
